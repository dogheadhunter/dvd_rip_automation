...
class WebScraperLauncher:
    ...
    def print_header(self):
        ...
        print("=" * 60)        print("Choose your scraping tool:\n")
    ...
    def print_menu(self):
        ...
        print()
        print("🔧 UTILITIES:")        print("  8️⃣  Clean Up Files         - Remove old logs and test data")
    ...
    def install_requirements(self):
        ...
        if req_file.exists():
            ...
            packages = ["beautifulsoup4", "requests", "fake-useragent", "aiohttp", "lxml"]
